...
export type KundenverwaltungDialogDefaults = Omit<Kundenverwaltung['fields'], 'zahlungsbedingungen'> & {
...
const NORMALIZE_LOOKUPS: Record<string, readonly { key: string; label: string }[]> = {
  zahlungsbedingungen: LOOKUP_OPTIONS['kundenverwaltung']?.['zahlungsbedingungen'] ?? [],
};
...
export function KundenverwaltungDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: KundenverwaltungDialogProps) {
  ...
  const REQUIRED_FIELDS = ['firmenname'] as const;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'firmenname': (
      <div key="firmenname" className="space-y-1.5">
        <Label htmlFor="firmenname">Firmenname <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
          id="firmenname"
    ...
    'email': (
      <div key="email" className="space-y-1.5">
        ...
        <Input
          id="email"
          type="email"
          placeholder="z. B. klaus@mueller-partner.de"
          value={fields.email ?? ''}
    ...
    'steuernummer': (
      <div key="steuernummer" className="space-y-1.5">
        ...
        <Input
          id="steuernummer"
          placeholder="z. B. 13 123 456 789"
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Besonderheiten, Kontaktinfos, Verträge..."
