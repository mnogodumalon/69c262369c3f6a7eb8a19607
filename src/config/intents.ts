...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-rechnung', label: 'Neue Rechnung', icon: IconFileInvoice, description: 'Rechnung mit Positionen in 4 Schritten erstellen' },
  { path: '/intents/rechnung-abschliessen', label: 'Rechnung abschließen', icon: IconCircleCheck, description: 'Offene Rechnung als bezahlt oder storniert markieren' },
  // </custom:intents>
];
